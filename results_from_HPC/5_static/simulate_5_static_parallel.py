...
plt.ylim(0)
plt.savefig('02613_HPC/Miniproject/Output_error_files/5_static/speedup.png')

np.save('02613_HPC/Miniproject/Output_error_files/5_static/speedup.npy', speedup)
np.save('02613_HPC/Miniproject/Output_error_files/5_static/n_proc_array.npy', n_proc_array)
np.save('02613_HPC/Miniproject/Output_error_files/5_static/time_for_proccesses.npy', time_for_proccesses)